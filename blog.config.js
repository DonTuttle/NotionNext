...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '此非', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://cifei.cfd/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '此非非彼非', // 网站关键词 英文逗号隔开
  ...
  PREVIEW_CATEGORY_COUNT: -1, // 首页最多展示的分类数量，0为不限制
  PREVIEW_TAG_COUNT: -1, // 首页最多展示的标签数量，0为不限制
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || '此非', // 站点标题 ，被notion中的页面标题覆盖
  ...
  DESCRIPTION: process.env.NEXT_PUBLIC_DESCRIPTION || '此非非彼非', // 站点描述，被notion中的页面描述覆盖
